    ...
    <div class="max-w-md mx-auto mt-10 bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
        ...
        <form method="POST" action="/register" class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-2">
                    <x-form-input id="name" name="name" type="text" placeholder="Jane Doe" :value="old('name')" required />
            ...
            <div>
                ...
                <div class="mt-2">
                    <x-form-input id="email" name="email" type="email" placeholder="janedoe@example.com"
            ...
            <div>
                ...
                <div class="mt-2">
                    <x-form-input id="password" name="password" type="password" placeholder="Create a password" required />
